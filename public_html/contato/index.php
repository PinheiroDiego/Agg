...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>Agência Bridge | Contato</title>
				...
				<div class="container">
					<div class="row">
						<div class="col-sm-12 text-center">
							<span class="text-white alt-font">tire suas dúvidas e solicite um orçamento</span>
				...
				<div class="container">
					<div class="row">
						<div class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2 text-center">
							...
							<p class="lead">
								Ficou com alguma dúvida? Estamos à disposição para esclarecer qualquer coisa referente a desenvolvimento de site, links patrocinados ou então identidade visual! Conte conosco!
							</p>
						</div>
					</div><!--end of row-->
