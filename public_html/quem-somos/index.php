...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>Agência Bridge | Quem Somos</title>
				...
				<div class="container">
					<div class="row">	
						<div class="col-md-8 col-md-offset-2 col-sm-10 col-sm-offset-1 text-center">
							<h1 class="text-white">Oi, prazer! Somos a Agência Bridge</h1>
							<p class="lead text-white">
								Atendimento diferenciado, preço justo e profissionalismo é o que você vai encontrar por aqui.
							</p>
					...
					<ul class="selector-content">
						<li class="clearfix active">
							...
							<div class="row">
								<div class="col-sm-12">
									<p class="lead">
										Uma parceria de 2 anos entre dois jovens culminou no nascimento da Agência Bridge no dia 05 de Janeiro de 2015. Através de profissionalização e experiência de ambos, percebemos que o mercado de desenvolvimento de site e divulgação na internet carece – e muito – de empresas que cumprem prazos e tem como pilar o atendimento e preço honesto. Com profissionais certificados pelo Google, possuímos clientes super satisfeitos! Nosso objetivo é que você e sua empresa cresçam. Seu sucesso é nosso combustível para continuar fazendo a diferença e vestir a camiseta de sua marca nos deixará muito feliz.
									</p>	
								</div>
								...
								<div class="col-sm-12">
									<p class="lead">
									<br>
										“ Tenho tanto orgulho do que nós não fazemos quanto tenho do que fazemos. ”<br>
										- Steve Jobs
									</p>	
								</div>
							</div><!--end of row-->
